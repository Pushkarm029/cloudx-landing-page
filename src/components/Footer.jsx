...
const Footer = () => {
  return (
    <footer className="relative bg-black bg-[url('/cta.png')] bg-no-repeat bg-center bg-cover -mt-20 py-40 px-60 flex justify-center items-start w-full gap-x-32"
  style={{ fontFamily: "'Inter', sans-serif", position: "relative" }}>
  
  {/* Gradient Fade Overlay */}
  <div className="absolute top-0 left-0 w-full h-12 bg-gradient-to-b from-black to-transparent"></div>
